...
<div class="d-flex row justify-content-center">
  <div class="col-md-6 col-lg-3">
    <div class="login-wrap margin2">
      <div class="bg-primary">
        <ul class="nav nav-tabs" id="" role="tablist">
          <li class="nav-item w-50">
            <a class="nav-link  text-white bg-primary " data-toggle="" href="{{ route('loginRS') }}" aria-expanded="true">Rumah Sakit</a>
          </li>
      ...
      <form action="{{ route('loginUser') }}" class="signin-form shadow p-3 mb-5 bg-white rounded" method="post">
        @csrf
        <div class="form-group">
          ...
          @endif
          <div class="form-group">
            <input type="email" name="email" class="form-control gray border-0" placeholder="Email" required>
          </div>
          <div class="form-group">
          ...
          <div class="form-group justify-content-center text-center mt-3">
            <p><a href="{{ route('registerUser') }}" style="color: blue" class="">Belum memiliki akun?</a> </p>
          </div>
        </div>
      </form>
    </div>
