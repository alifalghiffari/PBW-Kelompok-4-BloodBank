      ...
      <div class="bg-primary">
        <ul class="nav nav-tabs" id="" role="tablist">
          <li class="nav-item w-50">
            <a class="nav-link  text-white bg-primary " data-toggle="" href="{{ route('registerRS') }}" aria-expanded="true">Rumah Sakit</a>
          </li>
          <li class="nav-item w-50 text-md-right">
            <a class="nav-link text-dark bg-primary" id="" data-toggle="" href="" aria-expanded="false">Penerima</a>
          </li>
        </ul>
      </div>
      <form action="{{ route('registerUser') }}" method="post" class="signin-form shadow p-3 mb-5 bg-white rounded">
        @csrf
        <div class="form-group">
          ...
          <!--<div class="form-group">
                <input type="text" name="goldar" class="form-control  gray border-0" placeholder="Golongan Darah" required>
            </div>-->
          <div class="form-group">
            <input type="text" name="kota" class="form-control gray border-0" placeholder="Kota" required>
          </div>
          <div class="form-group">
            <input type="text" name="nohp" class="form-control gray border-0" placeholder="Nomor Hp Penerima" onkeypress="return hanyaAngka(event)" required>
          </div>
          <script>
          ...
          <div class="form-group">
            <input type="email" name="email" class="form-control gray border-0" placeholder="Email Penerima" required>
          </div>
          <div class="form-group">
          ...
          <div class="">
            <input type="hidden" name="hak_akses" class="form-control  gray border-0" value="user">
          </div>
          <div class="form-group">
          ...
          <div class="form-group justify-content-center text-center mt-3">
            <p><a href="{{ route('loginUser') }}" style="color: blue" class="">Sudah memiliki akun?</a> </p>
          </div>
        </div>
      </form>
    </div>
